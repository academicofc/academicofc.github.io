        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[min-content_min-content_1fr] lg:gap-y-12">
          <div className="lg:pl-20">
            <div className="max-w-s px-2.5 lg:max-w-none">
              <Image
                src={cartazImage}
                alt="Cartaz do Campo de Férias Hóquei em Patins no Académico FC 2026"
          ...
          <div className="lg:order-first lg:col-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
              Campo de Férias Hóquei em Patins no Académico FC 2026
            </h1>
          </div>
          <div className="lg:order-first lg:row-span-2 space-y-7">
            ...
            <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
              ...
              tanto atletas internos como externos, a começar dia 6 de julho com o
              seguinte calendário:
            </p>
            <ul role="list">
              <li className="flex">
                <CalendarDateRangeIcon className="h-6 w-6 flex-none" />
                <span className="ml-4">Semana 1: 6 a 10 de julho</span>
              </li>
              <li className="mt-4 flex">
                <CalendarDateRangeIcon className="h-6 w-6 flex-none" />
                <span className="ml-4">Semana 2: 13 a 17 de julho</span>
              </li>
            </ul>
          ...
          <div className="lg:pl-20">
            <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
              ...
              <ul className="mt-4" role="list">
                ...
                <li className="mt-4 flex">
                  <CalendarDateRangeIcon className="h-6 w-6 flex-none" />
                  <span className="ml-4">Semana 2: 13 a 17 de julho (lotada)</span>
                </li>
              </ul>
              ...
              <div class="mt-2 rounded-md bg-yellow-50 p-4 dark:bg-yellow-500/10 dark:outline dark:outline-yellow-500/15">
                <div class="flex">
                  <div class="shrink-0">
                  ...
                  <div class="ml-3">
                    <h3 class="text-sm font-medium text-yellow-800 dark:text-yellow-100">Semana 2 Lotada</h3>
                    <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-100/80">
                      <p>Devido à elevada procura, a Semana 2 já atingiu a sua lotação máxima. Continuam disponíveis vagas para a Semana 1.</p>
                    </div>
                  </div>
                </div>
              </div>
